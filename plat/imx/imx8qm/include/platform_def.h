...
#define ECOCKPIT_CLUSTER_CORE_COUNT	2
#define CLUSTER0_CCI_SLVAE_IFACE	4
#define CLUSTER1_CCI_SLVAE_IFACE	0

#define PLATFORM_CORE_COUNT		2

#elif (defined ECOCKPIT_A53)

#define PLATFORM_MAX_CPU_PER_CLUSTER	4
#define PLATFORM_CLUSTER_COUNT		1
#define ECOCKPIT_CLUSTER_CORE_COUNT	4
#define CLUSTER0_CCI_SLVAE_IFACE	3
#define CLUSTER1_CCI_SLVAE_IFACE	0

#define PLATFORM_CORE_COUNT		4

#else	/* !(defined ECOCKPIT_A53) */
